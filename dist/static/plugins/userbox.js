    ...
    kiwi.Vue.component('example-template', {
        ...
        template: `
            <div class="kiwi-userbox-basicinfo">
                <div v-if="user.realname.includes('irc.chateachat.com')">
                    <!-- Botón para mostrar el iframe -->
                    <button  @click="publicWebcam">Ver WebCam Pública</button>
                    <div >
                        <iframe style="height: 230px;" :src="user.realname"></iframe>
        ...
        data() {
            return {
                showPopup: false,
                iframeUrl: '',
                showIframe: false // Nueva propiedad para controlar la visibilidad del iframe
            };
        },
        methods: {
 publicWebcam() {
                if (this.network && this.user) {
                    ...
                    const command = `NOTICE ${nick} MIRAR`;
